...
for ineq_nr=16:16%NR_OF_INEQS
    ...
    MAX_ITER_BIG_LOOP = 20; % 4How many times to try the whole process
    ...
    CONST_CHI = pi/4-0.2;  % For the partially entangled states
    ...
    ALPHA_CONVERGENCE_THRESHOLD = 1e-7;
    VISIBILITY_CONVERGENCE_THRESHOLD = 1e-7;
