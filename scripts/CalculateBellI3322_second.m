...
I3322manualProj = A3*B2 + A2*B3 - A3*B1 - A1*B3 - A2*B2 - A2*B1 - A1*B2 -A1*B1 ...
                  - B1*(sym('Pi_1_2_1')+sym('Pi_1_2_2')) ...
                  - B2*(sym('Pi_1_2_1')+sym('Pi_1_2_2')) ...
                  - A1*(sym('Pi_2_1_1')+sym('Pi_2_1_2')) ...
                  - A2*(sym('Pi_2_1_1')+sym('Pi_2_1_2'));
                  

% 2*(sym('Pi_1_2_1')+sym('Pi_1_2_2'))*(sym('Pi_2_1_1')+sym('Pi_2_1_2')) + ... % offset for localbound
%                   -   A2*(sym('Pi_2_1_1')+sym('Pi_2_1_2')) ...
%                   -   B1*(sym('Pi_1_2_1')+sym('Pi_1_2_2'))...
...
I3322manualProj = subs(I3322manualProj, A1, sym('Pi_1_1_1')-sym('Pi_1_1_2'));        
I3322manualProj = subs(I3322manualProj, A2, sym('Pi_1_2_1')-sym('Pi_1_2_2'));  
I3322manualProj = subs(I3322manualProj, A3, sym('Pi_1_3_1')-sym('Pi_1_3_2'));  
I3322manualProj = subs(I3322manualProj, B1, sym('Pi_2_1_1')-sym('Pi_2_1_2'));  
I3322manualProj = subs(I3322manualProj, B2, sym('Pi_2_2_1')-sym('Pi_2_2_2'));  
I3322manualProj = subs(I3322manualProj, B3, sym('Pi_2_3_1')-sym('Pi_2_2_2'));  
I3322manualProj = expand(I3322manualProj);
...
ins = [4,3,2];
outs = [2,2,2];
ModifiedI3322 = I3322manualProj * (C1 + C2) + LBoundI3322 * A4 * (C1 - C2) * (sym('Pi_2_1_1')+sym('Pi_2_1_2'));
ModifiedI3322 = expand(ModifiedI3322);
ModifiedI3322 = subs(ModifiedI3322, C1, sym('Pi_3_1_1')-sym('Pi_3_1_2'));
ModifiedI3322 = subs(ModifiedI3322, C2, sym('Pi_3_2_1')-sym('Pi_3_2_2'));
ModifiedI3322 = subs(ModifiedI3322, A4, sym('Pi_1_4_2')-sym('Pi_1_4_2'));
ModifiedI3322 = expand(ModifiedI3322);
