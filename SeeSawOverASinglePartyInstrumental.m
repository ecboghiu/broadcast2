function [newPproj,bellineqvalue] = SeeSawOverASinglePartyInstrumental(partyidx, alpha, bellcoeffs, Pproj, channels, ins, outs)
    dimA = 2;
    dimB = 2;
    dimB1 = 2;
    dimB2 = 2;
    ...
    for d=1:outs(4)
        ...
        for k=1:dimA
        for l=1:dimB
            scnd = PartialTrace( ChoiMatrix(channels{w}{d}) * Tensor( ketbra(j,l,dimB).', idB1B2),...
                                1, [dimB,dimB1*dimB2] );
