function out = CompleteRoundFixedBell(bellcoeffs, belllocalbound, ins, outs)
    % TODO Fix this
    ins = {1:ins(1),1:ins(2),1:ins(3)};
    outs = {1:outs(1),1:outs(2),1:outs(3)};
