...
state = final_state(NoisyWernerState(0.7), channel);

disp(SeeSawOverChannel(state, bellcoeffs, POVMs))

function [newChoiMap,finalObj,problemStatus] = optimizer_SeeSawOverChannel(state, bellcoeffs, povms)
    dimA = 2;
    dimB = 2;
    dimB1 = 2;
    dimB2 = 2;
