...
for ineq_nr=60:80%NR_OF_INEQS
    ...
    IDENTITY_PLACEMENT = 'B'; % If using rho_A \otimes Id/2 (IDENTITY_PLACEMENT = 'B') or Id/2 \otimes rho_B (IDENTITY_PLACEMENT = 'B') 
